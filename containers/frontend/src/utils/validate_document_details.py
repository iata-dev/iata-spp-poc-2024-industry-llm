...
def validate_document_details(document_details):
    ...
    required_keys = {'awb_number': 'AWB Number', 'shipper': {'name': 'Shipper Name', 'address': 'Shipper Address'}, 'consignee': {'name': 'Consignee Name', 'address': 'Consignee Address'}, 'issuing_carrier_agent': {'name': 'Issuing Carrier Agent Name'}, 'cargo': {'pieces': 'Number of Pieces', 'weight': 'Weight', 'unit': 'Weight Unit', 'description': 'Cargo Description'}, 'charges': {'freight': 'Freight Charges', 'currency': 'Currency'}}
    missing_required = []
    missing_optional = []
